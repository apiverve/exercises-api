// Package exercises provides a Go client for the Exercises API.
//
// For more information, visit: https://apiverve.com/marketplace/exercises?utm_source=go&utm_medium=readme
package exercises
...
// Request contains the parameters for the Exercises API.
//
// Parameters:
...
type Request struct {
	Muscle string `json:"muscle,omitempty"` // Optional
	Name string `json:"name,omitempty"` // Optional
	Equipment string `json:"equipment,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Exercises API.
type ResponseData struct {
	Count int `json:"count"`
	FilteredOn []string `json:"filteredOn"`
	Exercises []ExercisesItem `json:"exercises"`
}

// ExercisesItem represents an item in the Exercises array.
