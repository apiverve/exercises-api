...
const (
	baseURL        = "https://api.apiverve.com/v1/exercises"
	defaultTimeout = 30 * time.Second
)

// Client is the Exercises API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Exercises API client.
...
// Execute makes a request to the Exercises API with typed parameters.
//
