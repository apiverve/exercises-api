 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/exercises?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/exercises';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ExercisesClient] {$message}\n";
        }
    }
}
