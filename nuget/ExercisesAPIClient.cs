...
namespace APIVerve.API.Exercises
{
...
#endif
    {
        ...
        {
            { "muscle", new ValidationRule { Type = "string", Required = false } },
            { "name", new ValidationRule { Type = "string", Required = false } },
            { "equipment", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public ExercisesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ExercisesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ExercisesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(ExercisesQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ExercisesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ExercisesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ExercisesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ExercisesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ExercisesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
