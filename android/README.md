...
```gradle
dependencies {
    implementation 'com.github.apiverve:exercises-api:1.1.13'
}
```
...
```java
import com.apiverve.exercises.ExercisesAPIClient;
import com.apiverve.exercises.APIResponse;
import com.apiverve.exercises.APIException;

// Initialize the client
ExercisesAPIClient client = new ExercisesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("muscle", "chest");
    parameters.put("name", "barbell");
    parameters.put("equipment", "barbell");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/exercises](https://docs.apiverve.com/ref/exercises)
...
- **Documentation:** [https://docs.apiverve.com/ref/exercises](https://docs.apiverve.com/ref/exercises)
- **Issues:** [GitHub Issues](https://github.com/apiverve/exercises-api/issues)
