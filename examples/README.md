# Exercises API - Examples

This folder contains example code for using the Exercises API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/exercises',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/exercises](https://docs.apiverve.com/ref/exercises)
