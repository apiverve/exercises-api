/*
 * Exercises API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Exercises API.
 * API Documentation: https://docs.apiverve.com/ref/exercises
 */
    ...
    class ExercisesExample
    {
        ...
        static async Task<JsonDocument> CallExercisesAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;muscle&quot;] &#x3D; &quot;chest&quot;, [&quot;name&quot;] &#x3D; &quot;barbell&quot;, [&quot;equipment&quot;] &#x3D; &quot;barbell&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Exercises API...\n");

            var result = await CallExercisesAPI();
